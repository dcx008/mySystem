...
Ext.ux.grid.LockingGridView = Ext.extend(Ext.grid.GridView, {
    ...
    updateLockedWidth: function(){
        ...
        if(this.innerHd){
            ...
            if(this.lockedInnerHd.firstChild.firstChild && this.lockedInnerHd.firstChild.firstChild.style){
            ...
            if(this.innerHd.firstChild.firstChild && this.innerHd.firstChild.firstChild.style){
